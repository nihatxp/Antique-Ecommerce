...
if (isset($_POST['Submit'])) {
    ...
    //print_r(adminCek($_POST['email']));
    if(adminCek($_POST['email'])!=null){
        
        if ((adminCek($_POST['email'])['parola'] == sha1($_POST['pwd']))) {
            $_SESSION['Admin'] = $_POST['email'];
            echo "<script> alert(window.location('/pages/index.php')) </script>";
            header("location: index.php");
            exit;

            if(isset($_POST['remember'])){
                // setAdminToken($_POST['email'], $token);//token yapmaya zamanim yetmedi ..
                setcookie("Admin", $token, time() + (86400 * 30), "/");
                echo "<script> alert('Cookie olusturuldu'); </script>";
            }
            else{
            ...
            ?>
                ...
                <div class="alert alert-danger alert-dismissible" role="alert">
                    ...
                    <strong>Hata!</strong> Parola Yanlis
                </div>
            <?php
        }
    }else{
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Admin Login Sayfası</title>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Admin Paneli Login Sayfası</h1>
                            </div>
                            <form action="" method="post" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" value="nihat.aliyev889@gmail.com" placeholder="john@ms.com" name="email" id="email" autofocus required>
                                    </div>
                                </div>
                                <!-- End of Form -->
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="Parola" value = "1234" class="form-control" name="pwd" id="password" required>
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="./recovery.php" class="small text-right">Parolanızı Mı Unuttunuz?</a></div>
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" name="Submit" class="btn btn-gray-800">Giriş Yap</button>
                                </div>
                            </form>
                            <div class="mt-3 mb-4 text-center">
                                <span class="fw-normal">veya</span>
                            </div>
